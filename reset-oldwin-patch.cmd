...
del C:\Windows\System32\acryptprimitives.dll
if %errorLevel% EQU 0 (
echo The patch is not present anymore. You can try another win 7 Tor redaction if this one was not running, or try this one again.
)
