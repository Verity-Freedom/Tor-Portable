[Назад на главную страницу (отсюда лучше видно интерфейс, например количество звёзд и релизы)](https://github.com/Verity-Freedom/Tor-Portable). Английский гайд по содержанию немного отличается от русского, если знаете английский, то стоит ознакомиться с ним.
