...
Для проксирования отдельных приложений Тором некоторые используют инструменты по типу [proxifyre](https://github.com/wiresock/proxifyre) или [Throne](https://github.com/throneproj/Throne), хотя много смысла я в этом не вижу, так как Тор не поддерживает UDP.
