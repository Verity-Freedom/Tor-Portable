...
Вы должны скачать [Psiphon TM](https://github.com/Verity-Freedom/Tor-Portable/releases/tag/v1.0) и открыть runme.cmd — он запускается и сразу сворачивается, подобно Тору. Чтобы использовать Psiphon вместо Тора, в настройках режима VIRTUAL поменяйте TOR на PROXY: так вы сможете прорвать блокировку на многие сайты с повышенной защитой. Учитывайте, что скорость Psiphon TM существенно ниже, чем у Тора. Чтобы использовать Psiphon вместо Антизапрета, в настройках режима AUTO замените Антизапрет на Антицензорити.
