...
В режиме pro выходной ip задан заранее, по принципу, что он является достаточно быстрым, стабильным и обходит блокировки Ютуба и Дискорда на Тор, хотя эти задачи в целом несколько противоречат друг другу, ибо такие блокировки действуют на наиболее популярные, а значит наиболее быстрые выходы. Например, имелись случаи, когда в default Дискорд запрещал отправлять изображения, а в pro всё работало корректно. Его минусом является возможность массового отказа для всех тех, у кого этот режим стоял. Мостов в режиме pro два, а не десять, ибо фундаментально, больше для работы ему не требуется; это также существенно влияет на время первого запуска в лучшую сторону.

Чтобы сменить режим работы с default на pro или обратно, зайдите в архив, замените свой torrc и перезапустите Тор. На скриншоте показано, как сменить один режим работы на другой. В Linux-версии режим pro стоит первым.
