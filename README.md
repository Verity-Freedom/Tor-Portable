...
Вы можете проявить креативный подход, поменяв тему расширения и цвета режимов. Для переключения между режимами используется quick switch, вы можете отключить его в любой момент, кликнув правой кнопкой мыши по расширению. Тогда режимы придётся выбирать вручную в меню, открывающемся левой кнопкой мыши по иконке, однако это не рекомендуется.
