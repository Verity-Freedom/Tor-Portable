...
7) <rawtext>*</rawtext> Open.spotify.com откроется, напротив, только в режиме TOR, иначе выдаст ошибку о блокировке региона.
