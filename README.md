...
AntiTor.exe, являясь скомпилированным скриптом cmd, тригерит большое количество антивирусов из-за особенностей самого компилятора, притом абсолютно любого, так как у batch не существует нативного, чистого компилятора. Однако без него невозможно закрепить программу в панель задач, не будет иконки. Особенно жёстким может оказаться антивирус Microsoft по умолчанию, в последние годы он стал этим печально известен, хотя в целом всего 20 из 70 антивирусов считают AntiTor.exe вредоносным, в то время как AntiTor.cmd вредоносным считают 0 антивирусов. Если вы не ожидаете борьбы с собственным антивирусом, скачайте AntiTor_win8+_antidetect.zip: в нём нет файла exe, и антивирусы жрать его не будут, но и в панель задач закрепить будет нечего. Пользователи седьмой винды могут действовать по своему усмотрению, ибо антивирус в ней значительно мягче.
