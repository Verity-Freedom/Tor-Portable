...
Режим TOR проксирует весь браузерный трафик, выглядит как фиолетовый круг с белым центром. В TOR возможно измерить скорость подключения, используйте для этого удобный вам сайт, например speedcheck.org. Вашей скорости должно с запасом хватать на 1080 60, на 2К 60. Режим TOR также используется для скрытия ip-адреса, но так как корпорации добра Гугл плевать на приватность своих пользователей (в отличие от Firefox), присутствует утечка на абсолютно любой странице без вашего ведома. Чтобы этого избежать, необходимо установить расширение [WebRTC Leak Shield](https://chromewebstore.google.com/detail/webrtc-leak-shield/bppamachkoflopbagkdoflbgfjflfnfl), проверяйте наличие утечек на [WebRTC Leak Test](https://browserleaks.com/webrtc).
