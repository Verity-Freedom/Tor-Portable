...
Основных режимов три — system, AUTO и VIRTUAL. Их вы можете переключать нажатием кнопки мыши по расширению, вам стоит сделать это сразу после синхронизации для начала использования (лучше остановиться на AUTO). Для корректной работы основные режимы используют несколько дополнительных.
