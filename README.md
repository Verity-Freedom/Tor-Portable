...
Всего используется три списка заблокированных сайтов: [Антизапрет](https://antizapret.prostovpn.org/), [Антицензорити](https://github.com/anticensority/generated-pac-scripts) и [no-russia-hosts](https://github.com/dartraiden/no-russia-hosts), имеющие различные функции.
...
Всего режимов три — system, AUTO и TOR. Их вы можете переключать нажатием кнопки мыши по расширению, вам стоит сделать это сразу после синхронизации для начала работы.
