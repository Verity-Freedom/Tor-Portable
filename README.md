...
AntiTor.exe, являясь скомпилированным скриптом cmd, тригерит большое количество антивирусов из-за особенностей самого компилятора, так как у batch не существует нативного, чистого компилятора. Однако без него невозможно закрепить программу в панель задач, не будет иконки. Особенно жёстким может оказаться Windows Defender, в последние годы он стал этим печально известен, хотя в целом всего 20 из 70 антивирусов считают AntiTor.exe вредоносным, в то время как AntiTor.cmd вредоносным считают 0 антивирусов. Если вы не ожидаете борьбы с собственным антивирусом, скачайте AntiTor_win8+AntiDetect.zip: в нём нет файла exe, и антивирусы жрать его не будут, но и в панель задач закрепить будет нечего, и выделяющаяся иконка отсутствует. Пользователи седьмой винды могут проигнорировать проблему, ибо антивирус в ней значительно мягче. Проблема будет актуальна до тех пор, пока я не подпишу файл exe легитимной корпоративной подписью; это стоит много денег, и я напоминаю, что задонатить мне можно на 5536 9141 8416 7645. Пишите, что донатите на подпись.
