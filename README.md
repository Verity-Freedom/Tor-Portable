...
By freeing the Tor core from the browser, I return to this technology the freedom that it should retain, and I always say that Tor is not a browser. Binding to a browser prevents maintaining support for Windows 7. [The mentioned exits issue has been acknowledged by the developers.](https://gitlab.torproject.org/tpo/core/tor/-/issues/41098). The Russian community [used](https://ntc.party/t/мосты-webtunnel-в-tor-browser/15595/150) a patched, censorship-resistant version of Webtunnel several months before the developers officially introduced similar changes (although the official version is safer and so significantly better, but hundreds of people benefited from the quick patch). The core itself is much lighter than the browser.
