...
Нам необходимо поставить расширения. Начнём с Обхода блокировок рунета ([Chrome](https://chromewebstore.google.com/detail/обход-блокировок-рунета/npgcnondjocldhldegnakemclmfkngch), [Firefox](https://addons.mozilla.org/ru/firefox/addon/обход-блокировок-рунета/)) — используем его как чекер, будет выводить нам домёны страницы при наведении на него мышкой, которые затем можно ввести в проксируемые Тором исключения.
