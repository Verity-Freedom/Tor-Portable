...
Для переключения между режимами используется quick switch, опционально вы можете отключить его в любой момент, кликнув правой кнопкой мыши по расширению. Тогда режимы придётся выбирать вручную в меню, открывающемся левой кнопкой мыши по иконке.
