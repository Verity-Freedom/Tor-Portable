...
Чтобы сменить режим работы с default на pro или обратно в автоматическом режиме (рекомендуется), запустите исполняемый файл change-mode (в зависимости от OS имеет расширение .sh или .cmd). На скриншоте показано, как сменить один режим работы на другой вручную. В Linux-версии первым стоит режим pro, а в Windows — default.
