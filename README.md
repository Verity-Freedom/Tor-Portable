...
6) ~~!*!~~ Первое задание повышенной сложности — доступ на сайт pixiv.net у вас будет только в режиме AUTO. Насколько мне известно, только в режиме AUTO также прогружаются аватарки на chess.com. Upd. pixiv.net может убивать к себе доступ из режима AUTO при помощи монструозных капч, это довольно печально и дополнительно усложняет задание !**!. Обходится заходом на более конкретный адрес по сравнению с pixiv.net и pixiv.net/en, например сразу нужный вам арт.
