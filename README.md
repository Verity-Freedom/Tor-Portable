...
В режиме pro выходной ip задан заранее, по принципу, что он является достаточно быстрым, стабильным и обходит блокировки Ютуба и Дискорда на Тор, хотя эти задачи в целом несколько противоречат друг другу, ибо такие блокировки действуют на наиболее популярные, а значит наиболее быстрые выходы. Например, имелись случаи, когда в default Дискорд запрещал отправлять изображения, а в pro всё работало корректно. Его минусом является возможность массового отказа для всех тех, у кого этот режим стоял; по сравнению с ним default является практически вечным. В случае отказа pro необходимо или переключиться на default, или так или иначе заменить вышедший из строя элемент. Мостов в режиме pro два, а не десять, ибо фундаментально, больше для работы Тору не требуется; это также существенно влияет на время первого запуска в лучшую сторону.
