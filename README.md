...
Тор же имеет фундаментальный недостаток — так как все его выходы открыты, он много где заблокирован, и при проксировании на весь трафик просто **неюзабелен**. Создатель Антизапрета, ValdikSS, также модифицировал один из самых популярных бесплатных впн своего времени — Psiphon, который до сих пор служит верой и правдой обходя блокировки, и породил его усиленную версию — Psiphon TM, для борьбы с цензурой в Туркменистане. Она медленнее чем оригинал (и я советую вам также [иметь при себе оригинал](https://psiphon.ca/ru/download-store.html)), но лучше защищена от блокировок и совместима с Антицензорити.

Антицензорити можно использовать как локальную версию Антизапрета вместе с Psiphon TM, и из-за отсутствия политики открытых выходов как ВПН он почти нигде не заблокирован. Для использования вам необходимо в настройках AUTO поменять дефолтный режим на Антицензорити, убедиться, что он успешно загружен, скачать [Psiphon TM](https://github.com/Verity-Freedom/Tor-Portable/releases/tag/v1.0) и запустить runme.cmd — он запускается и сразу сворачивается, подобно Тору. Также войдя в ZeroOmega в режим PROXY с запущенным Psiphon TM, вы можете прорвать блокировку на такие сайты, которые блокируют Тор, и при этом не попали в список Антизапрета, Антицензорити и AUTO-лист, но если вы захотите в него зайти, вам придётся сделать это вручную. Учитывайте, что скорость Psiphon TM существенно ниже комфорта (за комфорт я полагаю 2К60 без прогрузок). Также напоминаю, что оригинальный Psiphon невероятно хорош сам по себе, и стоит попробовать использовать его. Удачи.
