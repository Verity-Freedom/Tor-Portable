...
Откройте папку drover, запустите файл drover.exe и нажмите install. Это разблокирует клиентское приложение Дискорда вместе с голосовыми чатами без всяких задержек благодаря обходу UDP, но Тор должен работать или службой, или быть запущен как приложение.
